  ...
  class ContentTypesControllerTest < ActionController::TestCase
    ...
    test "should create content_type" do
      assert_difference('ContentType.count') do
        post :create, content_type: { content_type_attributes: @content_type.content_type_attributes, name: @content_type.name }
      end
    ...
    test "should update content_type" do
      put :update, id: @content_type, content_type: { content_type_attributes: @content_type.content_type_attributes, name: @content_type.name }
      assert_redirected_to content_type_path(assigns(:content_type))
    end
